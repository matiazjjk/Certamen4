...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ArrayAdapter <String> categoria = new ArrayAdapter<>(this, android.R.layout.simple_list_item_1,CategoriaS);
        Categoria.setAdapter(categoria);
        ArrayAdapter <String> ubicaciones = new ArrayAdapter<>(this, android.R.layout.simple_list_item_1,UbicacionS);
        Ubicacion.setAdapter(ubicaciones);
    ...
    public void EliminarProducto(View view){
        ...
        if (!IDProducto.isEmpty()){
            ...
            if (Eliminar == 1){
                Toast.makeText(this, "El producto se eliminó", Toast.LENGTH_LONG).show();
                ID.setText("");
                Nombre.setText("");
                Categoria.setSelection(0);
                Cantidad.setText("");
    ...
    public void ModificarProducto(View view) {
        ...
        if (!IDproducto.isEmpty() && !NombreProducto.isEmpty() && !CategoriaS.equals("Seleccione:") && !cantidad.equals("") && !precio.equals("") && !ubicacion.equals("Seleccione:")) {
            ...
            if (Update == 1) {
                Toast.makeText(this, "Datos Producto " + IDproducto + " ha sido actualizado.", Toast.LENGTH_SHORT).show();

            } else {
                Toast.makeText(this, "ID no reconocido", Toast.LENGTH_LONG).show();
                BaseDatos.close();
            }
        } else {
